// ./phasemodel -dim 3 -simplex 1 -temp_petscspace_degree 1 -dm_view -ts_type beuler -ts_max_steps 20 -pc_type bjacobi -ksp_monitor_short -ksp_rtol 1.e-12 -ksp_converged_reason -snes_type ksponly -snes_monitor_short -snes_lag_jacobian 1  -snes_converged_reason -ts_monitor  -vtk ../temperaturedata/Kidney1Left_04202017_Exp42/vesselregion.vtk  -log_summary  -dm_refine 4
                    ...
                    PetscReal t, PetscReal u_tShift, const PetscReal x[], PetscInt numConstants, const PetscScalar constants[], PetscScalar g0[])
{
  ...
  PetscScalar  ddoublewelldc =  4. * (u[0]-1)* (u[0]-1) + 8.*u[0]*(u[0]-1.) +  8.* u[0]*(u[0]-1) +   4*u[0]* u[0] ;
