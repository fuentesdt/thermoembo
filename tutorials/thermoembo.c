// ./heatdiffusionadvectionupwind -dim 3 -temp_petscspace_order 1 -pres_petscspace_order 1 -damg_petscspace_order 1 -conc_petscspace_order 1 -ts_type beuler -pc_type fieldsplit  -ksp_monitor_short -ksp_type preonly -ksp_converged_reason -snes_type newtonls  -snes_rtol 9.e-1 -snes_monitor_short -snes_lag_jacobian 1  -snes_converged_reason -ts_monitor -log_summary -artdiff 1e-6  -ts_max_steps 40 -ts_dt 1.e-1  -snes_linesearch_monitor -info -info_exclude  null,vec,mat,pc   -pc_fieldsplit_type additive  -fieldsplit_u_pc_type bjacobi  -fieldsplit_u_ksp_converged_reason -fieldsplit_u_ksp_monitor_short -fieldsplit_u_ksp_type gmres -fieldsplit_u_ksp_rtol 1.e-4  -fieldsplit_1_pc_type bjacobi -fieldsplit_1_ksp_rtol 1.e-9 -fieldsplit_1_ksp_converged_reason -fieldsplit_1_ksp_monitor_short -fieldsplit_1_ksp_type gmres  -salttemp .57
// PCApply_FieldSplit 

// ./heatdiffusionadvectionupwind -dim 3 -temp_petscspace_order 1 -pres_petscspace_order 1 -damg_petscspace_order 1 -conc_petscspace_order 1 -ts_type beuler -pc_type bjacobi -ksp_monitor_short -ksp_rtol 1.e-3 -ksp_converged_reason -snes_type ksponly  -snes_rtol 1.e-2 -snes_monitor_short -snes_lag_jacobian 1  -snes_converged_reason -ts_monitor -log_summary -artdiff 1e-6  -ts_max_steps 20 -ts_dt 1.e0  -snes_linesearch_monitor -info -info_exclude  null,vec,mat,pc

// ./heatdiffusionadvectionupwind -dim 3 -temp_petscspace_order 1 -pres_petscspace_order 1 -damg_petscspace_order 1 -conc_petscspace_order 1 -ts_type beuler -pc_type bjacobi -ksp_monitor_short -ksp_rtol 1.e-9 -ksp_converged_reason -snes_type newtonls  -snes_rtol 1.e-2 -snes_monitor_short -snes_lag_jacobian 5  -snes_converged_reason -ts_monitor -log_summary -artdiff 1e-7  -ts_max_steps 20 -ts_dt 1.e-2  -snes_linesearch_monitor -info -info_exclude  null,vec,mat,pc -o notemp
//
// ./heatdiffusionadvectionupwind -dim 3 -temp_petscspace_order 1 -pres_petscspace_order 1 -damg_petscspace_order 1 -conc_petscspace_order 1 -ts_type beuler -pc_type bjacobi -ksp_monitor_short -ksp_rtol 1.e-9 -ksp_converged_reason -snes_type newtonls  -snes_rtol 1.e-2 -snes_monitor_short -snes_lag_jacobian 5  -snes_converged_reason -ts_monitor -log_summary -artdiff 1e-7  -ts_max_steps 20 -ts_dt 1.e0  -advection 0.0 -snes_linesearch_monitor -info -info_exclude  null,vec,mat,pc
//
// ./heatdiffusionadvectionupwind -dim 3 -temp_petscspace_order 1 -pres_petscspace_order 1 -damg_petscspace_order 1 -conc_petscspace_order 1 -ts_type beuler -pc_type bjacobi -ksp_monitor_short -ksp_rtol 1.e-9 -ksp_converged_reason -snes_type ksponly  -snes_rtol 1.e-2 -snes_monitor_short -snes_lag_jacobian 1  -snes_converged_reason -ts_monitor -log_summary -artdiff 1e-7  -ts_max_steps 20 -ts_dt 1.e0  -advection 0.0
//
...
//
// SNESComputeJacobian
// ./heatdiffusionadvectionupwind -dim 3 -temp_petscspace_order 1 -pres_petscspace_order 1 -damg_petscspace_order 1 -conc_petscspace_order 1 -ts_type beuler -ts_max_steps 20 -ts_dt 1.e-3 -pc_type bjacobi -ksp_monitor_short -ksp_rtol 1.e-9 -ksp_converged_reason -snes_type newtonls  -snes_rtol 1.e-6 -snes_monitor_short -snes_lag_jacobian 1  -snes_converged_reason -ts_monitor -log_summary -artdiff 1e-7   -gamma 1.e2 -f  kidneyvessellores.e  -snes_compare_explicit > fd.log

// ./heatdiffusionadvectionupwind -dim 3 -temp_petscspace_order 1 -pres_petscspace_order 1 -damg_petscspace_order 1 -conc_petscspace_order 1 -ts_type beuler -ts_max_steps 20 -ts_dt 1.e-12 -pc_type bjacobi -ksp_monitor_short -ksp_rtol 1.e-9 -ksp_converged_reason -snes_type newtonls  -snes_rtol 1.e-6 -snes_monitor_short -snes_lag_jacobian 1  -snes_converged_reason -ts_monitor -log_summary -artdiff 1e-7   -gamma 1.e2 -f  kidneyvessellores.e  -advection 0.0 -snes_compare_explicit > fd.log

//
// ./heatdiffusionadvectionupwind -dim 3 -temp_petscspace_order 1 -pres_petscspace_order 1 -damg_petscspace_order 1 -conc_petscspace_order 1 -ts_type beuler -ts_max_steps 20 -ts_dt 1.e0 -pc_type bjacobi -ksp_monitor_short -ksp_rtol 1.e-9 -ksp_converged_reason -snes_type ksponly  -snes_monitor_short -snes_lag_jacobian 1  -snes_converged_reason -ts_monitor -log_summary -artdiff 1e-7 -velocity .001
// 
